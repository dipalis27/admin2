module BxBlockFedexIntegration
  class ShipmentService
    ...
    CLIENT_ID = @logistics_configuration&.client_id.to_s.freeze
    CLIENT_SECRET = @logistics_configuration&.client_secret.to_s.freeze
    API_KEY = @logistics_configuration&.logistic_api_key.to_s.freeze
