module BxBlockContactUs
  class ContactFilter
    ...
    #   "created_at"=>{"comparator": "between", "from": "2020-09-01", "to": "2020-09-30"},
    #   "updated_at"=>{"comparator": "between", "from": "2020-09-01", "to": "2020-09-30"},
    # }
    def initialize(active_record, query_params, date_format: DEFAULT_DATE_FORMAT)
    ...
    def call
      query_params.present? ? active_record.where(query_string) : active_record.all
    end
