...
module BxBlockOrderManagement
  class Tracking < BxBlockOrderManagement::ApplicationRecord
    ...
    def self.next_tracking_number
      return Tracking::TRACKING_NO_FORMAT.succ if Tracking.unscoped.count.nil?
      (Tracking.unscoped.count&.positive? ? Tracking.unscoped.last&.tracking_number&.split('TR')[1] : Tracking::TRACKING_NO_FORMAT).succ
    end
