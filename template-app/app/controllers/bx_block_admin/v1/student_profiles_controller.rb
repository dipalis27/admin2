  ...
  module V1
    class StudentProfilesController < ApplicationController
      ...
      def index
        ...
        render json: BxBlockStudentsData::StudentsSerializer.new(@allstudent).serializable_hash, status: :ok
      end

      def create
        student = BxBlockStudentsData::StudentProfile.new(student_params)
        if student.save
          render json: BxBlockStudentsData::StudentsSerializer.new(student).serializable_hash, status: :ok
        else
