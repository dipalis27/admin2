    ...
    class CataloguesController < ApplicationController
      ...
      def destroy
        ...
        if order_item_exist
          ...
          render json: { message: "You can't delete this product because few orders are associated with this product and product's status has been changed to Draft.", success: true}, status: :ok
